  ...
  <div class="space-y-4">
    <div class="vault-card">
      ...
      <p class="text-hd-bone/70 text-xs mb-3">
        The bearer is stored in the operating system's credential vault — not
        on disk. v0 limitation: the OAuth flow opens in your browser and you
      ...
      <p v-else class="text-hd-crimson text-xs mt-2">
        No bearer present.
      </p>
    </div>
    ...
    <div class="vault-card">
      ...
      <p class="text-hd-bone/40 text-xs mt-1">
        Pixel-perfect tuning ships in v0.2 — for now adjust the preset numbers
        in <span class="vault-rune">src/types/cube.ts</span> and rebuild.
      </p>
    </div>
    ...
    <div class="vault-card">
      ...
      <p class="text-hd-bone/40 text-xs mt-1">
        Modifiers: Ctrl, Shift, Alt, Super. Key: A–Z, F1–F12.
      </p>
    </div>
    ...
    <div class="vault-card">
      ...
      <div class="flex gap-2 flex-wrap">
        <button class="vault-button" :disabled="busy !== null" @click="syncNow">
          Sync catalog
        </button>
