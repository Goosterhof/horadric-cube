...
const authClass = computed(() => (state.authenticated ? 'text-emerald-400' : 'text-hd-crimson'));
</script>
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <div class="vault-card">
                ...
                <div v-if="state.authenticatedAt" class="text-hd-bone/50 text-xs">since this session</div>
            </div>
            <div class="vault-card">
            ...
            <div class="vault-card">
                ...
                <div class="vault-rune mt-1">{{ state.settings.region.width }}×{{ state.settings.region.height }}</div>
